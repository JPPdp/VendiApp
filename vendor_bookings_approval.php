...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (isset($_POST['deny'])) {
        $booking_id = $_POST['deny'];
        $status = "Denied";
    } else {
        // No valid action
        header("Location: vendor_bookings_approval.php");
        exit;
    }
...
<head>
    ...
    <title>Bookings Approval | Vendi</title>
    ...
    <div class="NAVIGATION_BAR">
        ...
        <div class="NAV_DROPDOWN">
            ...
            <div class="NAV_DROPDOWN_CONTENT_ACTIVE">
                <a href="vendor_bookings_approval.php" class="NAV_ACTIVE"><i class="fas fa-calendar-alt"></i> <span id="ITALIC">Pending Bookings</span></a>
    ...
    <div class="DASHBOARD" id="DASHBOARD">
        <div class="UPPER">
            <div class="LEFT_UPPER">
                <h1 class="DASHBOARD_TITLE"><i class="fas fa-calendar-alt"></i> Pending Bookings</h1>
            </div>
        ...
        <div class="BOOKING_TABLE">
                    ...
                    <table>
                        ...
                        <?php foreach ($pending_bookings as $booking): ?>
                            <tr>
                                ...
                                <td><?php echo date('M d, Y', strtotime($booking['service_date'])); ?> <small><?php echo date('h:i A', strtotime($booking['service_time'])); ?></small></td>
                                ...
                                <td>
                                    <button type="submit" name="approve" value="<?php echo $booking['booking_id']; ?>" class="ACTION_BUTTON" id="APPROVE_BUTTON">
                                        <i class="fas fa-check"></i> Approve
                                    </button>
                                    <button type="submit" name="deny" value="<?php echo $booking['booking_id']; ?>" class="ACTION_BUTTON" id="DENY_BUTTON">
            ...
            <?php else: ?>
                <table>
                    <tbody>
                        <tr>
                            <td colspan="9" class="NO_DATA_CELL">
