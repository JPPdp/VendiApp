    ...
    <div class="NAVIGATION_BAR">
        ...
        <div class="NAV_DROPDOWN">
            ...
            <div class="NAV_DROPDOWN_CONTENT_ACTIVE">
                ...
                <a href="vendor_bookings_completed.php" class="NAV_ACTIVE"><i class="fas fa-calendar-check"></i> <span id="ITALIC">Completed Bookings</span></a>
                    ...
                    <?php foreach ($completed_bookings as $booking): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                at <?php echo date('h:i A', strtotime($booking['service_time'])); ?>
                            </td>
