...
<head>
    ...
    <title>Cancelled Bookings | Vendi</title>
    ...
    <div class="NAVIGATION_BAR">
        ...
        <div class="NAV_DROPDOWN">
            ...
            <div class="NAV_DROPDOWN_CONTENT_ACTIVE">
                ...
                <a href="vendor_bookings_cancelled.php" class="NAV_ACTIVE"><i class="fas fa-calendar-times"></i> <span id="ITALIC">Cancelled Bookings</span></a>
            </div>
        </div>
        ...
        <div class="BOOKING_TABLE">
                    ...
                    <?php foreach ($cancelled_bookings as $booking): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php if (!empty($booking['service_time'])): ?>
            ...
            <?php else: ?>
                <table>
                    <tbody>
                        <tr>
                            <td colspan="6" class="NO_DATA_CELL">
