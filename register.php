...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password !== $confirm_password) {
        ...
        if ($stmt->num_rows > 0) {
            ...
            if ($stmt = $conn->prepare("INSERT INTO vendors (businessname, email, mobile, password, address, city_municipal, province) VALUES (?, ?, ?, ?, ?, ?, ?)")) {
                $stmt->bind_param("sssssss", $businessname, $email, $mobile, $hashed_password, $address, $city_municipal, $province);
