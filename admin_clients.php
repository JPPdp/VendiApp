                    ...
                    <form action="admin_clients.php" method="POST">
                        <table>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="USER_ID"><?php echo htmlspecialchars($client['client_id']); ?></td>
                                    <td class="PROFILE_PICTURE">
                                        <div class="CIRCULAR_IMAGE_CONTAINER">
                                            <img src="<?php echo htmlspecialchars($client['client_profile']); ?>" alt="Profile Picture" class="CIRCULAR_IMAGE">
                                        </div>
                                    </td>
                                    <td class="CLIENT_NAME"><?php echo htmlspecialchars($client['client_name']); ?></td>
                                    <td class="CLIENT_EMAIL"><?php echo htmlspecialchars($client['client_email']); ?></td>
                                    <td class="MOBILE_NUMBER"><?php echo htmlspecialchars($client['client_mobile']); ?></td>
